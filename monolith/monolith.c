 ...
 * Monolith Mod Loader
 *
 * Original work Copyright (c) 2019 Kavawuvi
 * Modified work Copyright (c) 2019 gbMichelle
 * Modifications:
 *      Removed the restriction that other mods can only load if Chimera can be
 *      loaded.
 *      Removed the warning that is normally shown if Chimera isn't loaded.
 *      Made DLL report load as succesful under all conditions.
 *      Removed termination.
 *      Changed the _WIN32_WINNT define to be compiler universal.
 *
