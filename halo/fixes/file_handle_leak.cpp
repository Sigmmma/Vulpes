...
PatchNew(file_handle_leak_patch1, sig_file_handle_leak1, 1, 4, INT_PATCH, NEW_ALLOCATION_SIZE);
PatchNew(file_handle_leak_patch2, sig_file_handle_leak2, 2, 4, INT_PATCH, NEW_ALLOCATION_SIZE);
PatchNew(file_handle_leak_patch3, sig_file_handle_leak3, 1, 4, INT_PATCH, NEW_ALLOCATION_SIZE);
